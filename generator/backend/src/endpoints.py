...
@inject
def generate_crossword_clues(log: Logger = Provide[Core.log], generator: ClueGenerator = Provide[Core.clue_generator]):
...
@inject
def generate_crossword_clues_with_words(log: Logger = Provide[Core.log], generator: ClueGenerator = Provide[Core.clue_generator]):
